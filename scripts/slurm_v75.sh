#!/bin/bash
#SBATCH --job-name=mj_v75_off02_yaw10
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v75_off02_yaw10_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v75_off02_yaw10_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name v75_off02_yaw10 \
    --output_dir outputs/mujoco_td3/v75_off02_yaw10 \
