...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v14_small_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v14_small_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v14_small/${TIMESTAMP}"

echo "=== v14_small: Small networks ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v14_small_${TIMESTAMP}" \
