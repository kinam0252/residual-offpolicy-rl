...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v25_100k_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v25_100k_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v25_100k/${TIMESTAMP}"

echo "=== v25_100k: 100K steps ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v25_100k_${TIMESTAMP}" \
