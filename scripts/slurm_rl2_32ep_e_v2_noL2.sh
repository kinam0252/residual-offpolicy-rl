...
#SBATCH --mem=200G
#SBATCH --job-name=rl2_32ep_e_v2_noL2
#SBATCH --output=/home/nas_main/kinamkim/slurms/rl2_32ep_e_v2_noL2_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/rl2_32ep_e_v2_noL2_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --action_l2_reg 0.0 \
    --offline_data_dir /home/nas_main/kinamkim/Repos/Intern/outputs/offline_data/gr00t_sim_32ep/easy \
    ...
    --n_step 3 \
    --seed 42 \
    --output_dir outputs/mujoco_td3/gr00t_sim_32ep/easy_v2_noL2 \
    --wandb_mode online \
    --wandb_project mujoco-resfit \
    --wandb_name rl2_32ep_easy_v2_noL2
