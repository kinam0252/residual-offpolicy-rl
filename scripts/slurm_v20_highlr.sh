...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v20_highlr_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v20_highlr_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v20_highlr/${TIMESTAMP}"

echo "=== v20_highlr: High learning rate ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v20_highlr_${TIMESTAMP}" \
