#!/bin/bash
#SBATCH --job-name=mj_v33_nol2_highnoise
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v33_nol2_highnoise_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v33_nol2_highnoise_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v33_nol2_highnoise/${TIMESTAMP}"

echo "=== v33_nol2_highnoise: No L2 + high noise 0.15, 500K steps ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v33_nol2_highnoise_${TIMESTAMP}" \
