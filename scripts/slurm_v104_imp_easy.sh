#!/bin/bash
#SBATCH --job-name=mj_v104_imp_easy
#SBATCH --partition=core
#SBATCH --qos=core-own
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=24
#SBATCH --mem=200G
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v104_imp_easy_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v104_imp_easy_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --offline_data_dir outputs/offline_data/sim_groot_v2_70k_noema_easy_success \
    --offline_fraction 0.1 \
    --wandb_name v104_imp_easy \
    --output_dir outputs/mujoco_td3/v104_imp_easy \
