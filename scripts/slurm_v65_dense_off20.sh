#!/bin/bash
#SBATCH --job-name=mj_v65_dense_off20
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v65_dense_off20_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v65_dense_off20_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name v65_dense_off20 \
    --output_dir outputs/mujoco_td3/v65_dense_off20 \
    --offline_data_dir outputs/offline_data/dense_v1_20260404_224233 \
    --action_l2_reg 0.1 --action_scale 0.2 --max_episode_steps 500 --stddev_max 0.05 --stddev_min 0.05 --offline_fraction 0.2
