#!/bin/bash
#SBATCH --job-name=col_66ep_h
#SBATCH --output=/home/nas_main/kinamkim/slurms/col_66ep_h_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/col_66ep_h_%j.out
...
python3 resfit/rl_finetuning/scripts/collect_offline_data.py \
    ...
    --random_cube_range '{"dx":[-12,16],"dy":[-20,20]}' \
    --num_episodes_per_env 320 \
    --max_episode_steps 500 \
    --output_dir /home/nas_main/kinamkim/Repos/Intern/outputs/offline_data/gr00t_sim_66ep/hard \
