...
#SBATCH --mem=200G
#SBATCH --time=2:00:00
#SBATCH --job-name=gen_v71_v2unseen_y10
#SBATCH --output=/home/nas_main/kinamkim/slurms/gen_v71_v2unseen_y10_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/gen_v71_v2unseen_y10_%j.err
...
python -m resfit.rl_finetuning.scripts.eval_checkpoint \
    ...
    --checkpoint outputs/mujoco_td3/v71_off02_yaw0/checkpoints/best.pt \
    --eval_num_episodes 2 \
    --asymmetric_critic \
    --action_scale 0.2 --actor_hidden_dim 512 --critic_hidden_dim 1024 \
    --seed 42 \
    --cube_yaw 10.0 \
    --output_json outputs/eval_results/gen_v71_v2unseen_y10.json \
    --label gen_v71_v2unseen_y10
