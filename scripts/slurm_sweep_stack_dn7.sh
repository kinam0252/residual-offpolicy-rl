...
#SBATCH --output=/home/nas_main/kinamkim/slurms/stk_dn7_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/stk_dn7_%j.err
...
# dn7: drawer-best config (as=0.05, L2=0.01, cw=1000)
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco_stack.py \
    ...
    --action_scale 0.05 \
    --seed 42 \
    --output_dir outputs/stack_rl/dn7_drawer_best
