...
#SBATCH --mem=200G
#SBATCH --job-name=mj_v116_norm_cmb
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v116_norm_cmb_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v116_norm_cmb_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --output_dir outputs/mujoco_td3/v116_100k_normal_combo \
    --wandb_mode online \
    --wandb_project mujoco-resfit \
    --wandb_name v116_100k_normal_combo
