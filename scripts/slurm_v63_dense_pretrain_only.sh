#!/bin/bash
#SBATCH --job-name=mj_v63_dense_pretrain_only
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v63_dense_pretrain_only_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v63_dense_pretrain_only_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name v63_dense_pretrain_only \
    --output_dir outputs/mujoco_td3/v63_dense_pretrain_only \
    --offline_data_dir outputs/offline_data/dense_v1_20260404_224233 \
    --action_l2_reg 0.1 --action_scale 0.2 --max_episode_steps 500 --stddev_max 0.05 --stddev_min 0.05 --offline_fraction 0.5 --offline_pretrain_only --critic_warmup_steps 2000
