#!/bin/bash
#SBATCH --job-name=mj_v32_nol2_bigscale
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v32_nol2_bigscale_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v32_nol2_bigscale_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v32_nol2_bigscale/${TIMESTAMP}"

echo "=== v32_nol2_bigscale: No L2 + action_scale 0.3, 500K steps ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v32_nol2_bigscale_${TIMESTAMP}" \
