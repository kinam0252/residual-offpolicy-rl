#!/bin/bash
#SBATCH --job-name=mj_v47_aggressive
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v47_aggressive_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v47_aggressive_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v47_aggressive/${TIMESTAMP}"

echo "=== v47_aggressive: No L2 + scale=0.5 + ep500 + noise=0.1, 500K steps ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v47_aggressive_${TIMESTAMP}" \
