...
#SBATCH --mem=200G
#SBATCH --job-name=rl_32ep_h_s7
#SBATCH --output=/home/nas_main/kinamkim/slurms/rl_32ep_h_s7_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/rl_32ep_h_s7_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --n_step 3 \
    --seed 7 \
    --output_dir outputs/mujoco_td3/gr00t_sim_32ep/hard_s7 \
    --wandb_mode online \
    --wandb_project mujoco-resfit \
    --wandb_name rl_32ep_hard_s7
