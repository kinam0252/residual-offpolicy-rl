...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v19_sparse_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v19_sparse_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v19_sparse/${TIMESTAMP}"

echo "=== v19_sparse: Sparse reward ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v19_sparse_${TIMESTAMP}" \
