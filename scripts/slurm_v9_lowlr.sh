...
OUTPUT_DIR="outputs/mujoco_td3_v9_lowlr/${TIMESTAMP}"

echo "=== v9: Lower actor_lr=3e-7 (original resfit default), asymmetric ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --eval_interval 1000 --eval_num_episodes 5 \
    --seed 42 \
    --output_dir "${OUTPUT_DIR}" \
    --wandb_mode online --wandb_project mujoco-franka-residual-td3 \
    --wandb_name "v9_lowlr_3e7_asym_${TIMESTAMP}"
