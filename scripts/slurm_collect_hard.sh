#!/bin/bash
#SBATCH --job-name=collect_sim_hard
#SBATCH --partition=core
#SBATCH --qos=core-own
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=24
#SBATCH --mem=200G
#SBATCH --output=/home/nas_main/kinamkim/slurms/collect_sim_hard_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/collect_sim_hard_%j.err
...
python3 resfit/rl_finetuning/scripts/collect_offline_data.py \
    ...
    --ema_alpha 0.7 \
    --output_dir outputs/offline_data/sim_groot_v2_ema07_hard \
