...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v30_nol2_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v30_nol2_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v30_nol2/${TIMESTAMP}"

echo "=== v30_nol2: No L2 penalty, 500K steps ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v30_nol2_${TIMESTAMP}" \
