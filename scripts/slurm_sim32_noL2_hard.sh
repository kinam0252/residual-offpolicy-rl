...
#SBATCH --mem=200G
#SBATCH --job-name=mj_noL2_hard
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_noL2_hard_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_noL2_hard_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --action_l2_reg 0.0 \
    --offline_data_dir outputs/offline_data/gr00t_sim_32ep/noL2_hard_merged \
    ...
    --output_dir outputs/mujoco_td3/gr00t_sim_32ep/noL2_hard \
    --wandb_mode online \
    --wandb_project mujoco-resfit \
    --wandb_name sim32_noL2_hard
