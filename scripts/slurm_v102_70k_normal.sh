#!/bin/bash
#SBATCH --job-name=mj_v102_70k_normal
#SBATCH --partition=sub
#SBATCH --qos=core-on-sub
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=24
#SBATCH --mem=200G
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v102_70k_normal_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v102_70k_normal_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name v102_70k_normal \
    --output_dir outputs/mujoco_td3/v102_70k_normal \
