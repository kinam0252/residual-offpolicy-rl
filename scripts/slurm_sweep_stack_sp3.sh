#!/bin/bash
#SBATCH --job-name=stk_sp3
#SBATCH --partition=sub
#SBATCH --qos=core-on-sub
#SBATCH --nodelist=worker-10
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=14
#SBATCH --mem=200G
#SBATCH --time=72:00:00
#SBATCH --output=/home/nas_main/kinamkim/slurms/stk_sp3_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/stk_sp3_%j.err
...
# Exp3: sparse + gamma=0.995 + n_step=5 (max signal propagation)
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco_stack.py \
    ...
    --action_scale 0.1 \
    --seed 42 \
    --output_dir outputs/stack_rl/sp3_g995_n5_a10
