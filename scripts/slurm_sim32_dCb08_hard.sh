...
#SBATCH --mem=200G
#SBATCH --job-name=mj_dCb08_hard
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_dCb08_hard_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_dCb08_hard_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --output_dir outputs/mujoco_td3/gr00t_sim_32ep/denseClip_s08_hard \
    --wandb_mode online \
    --wandb_project mujoco-resfit \
    --wandb_name sim32_denseClip_s08_hard
