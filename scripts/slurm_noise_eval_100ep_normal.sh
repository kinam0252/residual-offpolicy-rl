...
#SBATCH --mem=200G
#SBATCH --job-name=noise_normal
#SBATCH --output=/home/nas_main/kinamkim/slurms/noise_normal_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/noise_normal_%j.err
