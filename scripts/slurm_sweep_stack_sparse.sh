...
#SBATCH --output=/home/nas_main/kinamkim/slurms/stk_sparse_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/stk_sparse_%j.err
...
# Sparse reward experiment based on r05_a01 (best dense config)
# Changes vs r05_a01: reward_type=sparse, offline_reward_relabel=sparse, gamma=0.99
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco_stack.py \
    ...
    --wandb_mode offline \
    --reward_type sparse \
    --offline_reward_relabel sparse \
    --residual_rot_scale 0.05 \
    --action_scale 0.1 \
    --seed 42 \
    --output_dir outputs/stack_rl/sweep_sparse_g99
