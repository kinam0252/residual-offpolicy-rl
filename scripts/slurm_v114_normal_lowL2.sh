...
#SBATCH --mem=200G
#SBATCH --job-name=mj_v114_norm_lowL2
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v114_norm_lowL2_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v114_norm_lowL2_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --output_dir outputs/mujoco_td3/v114_100k_normal_lowL2 \
    --wandb_mode online \
    --wandb_project mujoco-resfit \
    --wandb_name v114_100k_normal_lowL2
