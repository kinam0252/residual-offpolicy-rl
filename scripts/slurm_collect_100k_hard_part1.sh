#!/bin/bash
#SBATCH --job-name=col_hard_p1
#SBATCH --partition=core
#SBATCH --qos=core-extra
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=14
#SBATCH --mem=200G
#SBATCH --output=/home/nas_main/kinamkim/slurms/col_hard_p1_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/col_hard_p1_%j.err
...
python3 resfit/rl_finetuning/scripts/collect_offline_data.py \
    ...
    --output_dir outputs/offline_data/sim_groot_v2_100k_hard_part1 \
