#!/bin/bash
#SBATCH --job-name=mj_v44_best_combo
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v44_best_combo_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v44_best_combo_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v44_best_combo/${TIMESTAMP}"

echo "=== v44_best_combo: No L2 + scale=0.3 + ep500 + noise=0.1, 500K steps ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v44_best_combo_${TIMESTAMP}" \
