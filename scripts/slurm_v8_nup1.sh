...
OUTPUT_DIR="outputs/mujoco_td3_v8_nup1/${TIMESTAMP}"

echo "=== v8: num_updates=1 (less aggressive updates), asymmetric ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v8_nup1_asym_${TIMESTAMP}"
