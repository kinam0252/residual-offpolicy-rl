#!/bin/bash
#SBATCH --job-name=mj_v95_70k_easy
#SBATCH --partition=core
#SBATCH --qos=core-own
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=24
#SBATCH --mem=200G
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v95_70k_easy_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v95_70k_easy_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name v95_70k_easy \
    --output_dir outputs/mujoco_td3/v95_70k_easy \
