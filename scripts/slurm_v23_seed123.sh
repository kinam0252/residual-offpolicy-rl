#!/bin/bash
#SBATCH --job-name=mj_v23_seed123
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v23_seed123_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v23_seed123_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v23_seed123/${TIMESTAMP}"

echo "=== v23_seed123: Seed 123 ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v23_seed123_${TIMESTAMP}" \
