...
#SBATCH --mem=200G
#SBATCH --job-name=rl2_100ep_e_v2_noL2
#SBATCH --output=/home/nas_main/kinamkim/slurms/rl2_100ep_e_v2_noL2_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/rl2_100ep_e_v2_noL2_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --output_dir outputs/mujoco_td3/gr00t_sim_100ep/easy_v2_noL2 \
    --wandb_mode online \
    --wandb_project mujoco-resfit \
    --wandb_name rl2_100ep_easy_v2_noL2
