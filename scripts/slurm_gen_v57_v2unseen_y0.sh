...
#SBATCH --mem=200G
#SBATCH --time=2:00:00
#SBATCH --job-name=gen_v57_v2unseen_y0
#SBATCH --output=/home/nas_main/kinamkim/slurms/gen_v57_v2unseen_y0_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/gen_v57_v2unseen_y0_%j.err
...
python -m resfit.rl_finetuning.scripts.eval_checkpoint \
    ...
    --seed 42 \
    --output_json outputs/eval_results/gen_v57_v2unseen_y0.json \
    --label gen_v57_v2unseen_y0
