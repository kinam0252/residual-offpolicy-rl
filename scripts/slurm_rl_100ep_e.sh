...
#SBATCH --mem=200G
#SBATCH --job-name=rl_100ep_e
#SBATCH --output=/home/nas_main/kinamkim/slurms/rl_100ep_e_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/rl_100ep_e_%j.err
#SBATCH --time=72:00:00
#SBATCH --exclude=worker-1
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --action_l2_reg 0.01 \
    --offline_data_dir /home/nas_main/kinamkim/Repos/Intern/outputs/offline_data/gr00t_sim_100ep/easy \
    ...
    --resume_checkpoint outputs/mujoco_td3/gr00t_sim_100ep/easy_s1L2_s2/checkpoints/resume_latest.pt \
    --output_dir outputs/mujoco_td3/gr00t_sim_100ep/easy_s1L2_s2 \
    --wandb_mode online \
    --wandb_project mujoco-resfit \
    --wandb_name rl_100ep_easy_s1L2_s2
