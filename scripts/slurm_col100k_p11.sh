...
#SBATCH --output=/home/nas_main/kinamkim/slurms/col100k_p11_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/col100k_p11_%j.err
#SBATCH --time=4:00:00
...
python3 resfit/rl_finetuning/scripts/collect_offline_data.py \
    ...
    --output_dir outputs/offline_data/sim_groot_v2_100k_part11
