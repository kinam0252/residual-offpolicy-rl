...
#SBATCH --mem=200G
#SBATCH --job-name=rl_32ep_h
#SBATCH --output=/home/nas_main/kinamkim/slurms/rl_32ep_h_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/rl_32ep_h_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --n_step 3 \
    --seed 2 \
    --output_dir outputs/mujoco_td3/gr00t_sim_32ep/hard_s1L2_s2 \
    --wandb_mode online \
    --wandb_project mujoco-resfit \
    --wandb_name rl_32ep_hard_s1L2_s2
