...
#SBATCH --mem=200G
#SBATCH --job-name=rl_100ep_h_s42
#SBATCH --output=/home/nas_main/kinamkim/slurms/rl_100ep_h_s42_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/rl_100ep_h_s42_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --output_dir outputs/mujoco_td3/gr00t_sim_100ep/hard_s1L2_s42 \
    --wandb_mode online \
    --wandb_project mujoco-resfit \
    --wandb_name rl_100ep_hard_s1L2_s42
