...
#SBATCH --mem=200G
#SBATCH --job-name=mj_S1h_s42
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_S1h_s42_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_S1h_s42_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --output_dir outputs/mujoco_td3/gr00t_sim_32ep/denseClip_S1_noL2_hard_s42 \
    --wandb_mode online \
    --wandb_project mujoco-resfit \
    --wandb_name sim32_denseClip_S1_noL2_hard_s42
