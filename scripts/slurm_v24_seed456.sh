#!/bin/bash
#SBATCH --job-name=mj_v24_seed456
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v24_seed456_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v24_seed456_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v24_seed456/${TIMESTAMP}"

echo "=== v24_seed456: Seed 456 ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v24_seed456_${TIMESTAMP}" \
