...
#SBATCH --mem=200G
#SBATCH --job-name=mj_dC08L2_nm
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_dC08L2_nm_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_dC08L2_nm_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --output_dir outputs/mujoco_td3/gr00t_sim_32ep/denseClip_s08_L2_norm \
    --wandb_mode online \
    --wandb_project mujoco-resfit \
    --wandb_name sim32_denseClip_s08_L2_norm
