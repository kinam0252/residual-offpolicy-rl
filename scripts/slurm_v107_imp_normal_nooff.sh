#!/bin/bash
#SBATCH --job-name=mj_v107_nooff
#SBATCH --partition=core
#SBATCH --qos=core-extra
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=24
#SBATCH --mem=200G
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v107_nooff_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v107_nooff_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name v107_imp_normal_nooff \
    --output_dir outputs/mujoco_td3/v107_imp_normal_nooff \
