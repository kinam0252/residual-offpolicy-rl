...
#SBATCH --output=/home/nas_main/kinamkim/slurms/stk_r10a1_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/stk_r10a1_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco_stack.py \
    ...
    --wandb_mode offline \
    --residual_rot_scale 0.10 \
    --action_scale 0.1 \
    --seed 42 \
    --output_dir outputs/stack_rl/sweep_rot10_act01
