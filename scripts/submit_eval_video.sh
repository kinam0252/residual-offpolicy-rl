...
OUTPUT_DIR="${OUTPUT_DIR:-outputs/eval_video/default}"
LABEL="${LABEL:-}"
SEED="${SEED:-0}"

CMD="python3 scripts/eval_pnp_video.py --output-dir $OUTPUT_DIR --seed $SEED"
CMD="$CMD --positions-file configs/pnp_eval_hard.json"
