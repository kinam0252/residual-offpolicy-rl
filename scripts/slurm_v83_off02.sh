...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v83_off02_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v83_off02_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name v83_rand_normal_off02 \
    --output_dir outputs/mujoco_td3/v83_rand_normal_off02 \
