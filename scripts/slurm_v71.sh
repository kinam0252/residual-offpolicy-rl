#!/bin/bash
#SBATCH --job-name=mj_v71_off02_yaw0
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v71_off02_yaw0_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v71_off02_yaw0_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name v71_off02_yaw0 \
    --output_dir outputs/mujoco_td3/v71_off02_yaw0 \
