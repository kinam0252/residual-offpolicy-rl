#!/bin/bash
#SBATCH --job-name=mj_v34_balanced
...
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v34_balanced_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v34_balanced/${TIMESTAMP}"

echo "=== v34_balanced: Balanced: L2=1 scale=0.2 noise=0.1, 500K steps ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v34_balanced_${TIMESTAMP}" \
