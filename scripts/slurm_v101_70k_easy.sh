#!/bin/bash
#SBATCH --job-name=mj_v101_70k_easy
#SBATCH --partition=sub
#SBATCH --qos=core-on-sub
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=24
#SBATCH --mem=200G
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v101_70k_easy_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v101_70k_easy_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --action_l2_reg 0.1 --action_scale 0.2 --max_episode_steps 300 \
    --critic_warmup_steps 2000 \
    --offline_data_dir outputs/offline_data/sim_groot_v2_70k_noema_easy \
    --offline_fraction 0.2 \
    --wandb_name v101_70k_easy \
    --output_dir outputs/mujoco_td3/v101_70k_easy \
