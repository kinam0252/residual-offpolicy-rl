...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v11_off80_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v11_off80_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v11_off80/${TIMESTAMP}"

echo "=== v11_off80: 80% offline mixing ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v11_off80_${TIMESTAMP}" \
