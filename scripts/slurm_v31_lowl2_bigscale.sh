#!/bin/bash
#SBATCH --job-name=mj_v31_lowl2_bigscale
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v31_lowl2_bigscale_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v31_lowl2_bigscale_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v31_lowl2_bigscale/${TIMESTAMP}"

echo "=== v31_lowl2_bigscale: Low L2 (1.0) + action_scale 0.3, 500K steps ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v31_lowl2_bigscale_${TIMESTAMP}" \
