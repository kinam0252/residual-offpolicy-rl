...
exec ./isaaclab.sh -p /home/t-kinamkim/Repos/VLA_RL/residual-offpolicy-rl/resfit/rl_finetuning/scripts/eval_single_run.py \
  ...
  --checkpoint "/home/t-kinamkim/Repos/VLA_RL/residual-offpolicy-rl/outputs/pickMushroom_resid_v16_l2reg/20260315_200019/checkpoints/best_agent.pt" \
  --env_type unseen \
  --run_label v16_best_unseen \
  --output_dir "/home/t-kinamkim/Repos/VLA_RL/residual-offpolicy-rl/outputs/unseen_eval_v16_vs_v20a/v16_best_unseen" \
