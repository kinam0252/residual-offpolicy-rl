#!/bin/bash
#SBATCH --job-name=beval_100ep_n
#SBATCH --partition=core
#SBATCH --qos=core-own
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=24
#SBATCH --mem=200G
#SBATCH --output=/home/nas_main/kinamkim/slurms/beval_100ep_n_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/beval_100ep_n_%j.err
#SBATCH --time=4:00:00
...
export EVAL_OUT=outputs/100ep/base_eval_normal
