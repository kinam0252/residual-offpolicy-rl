...
#SBATCH --mem=80G
#SBATCH --job-name=fair_ema
#SBATCH --output=/home/nas_main/kinamkim/slurms/fair_ema_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/fair_ema_%j.err
...
echo "[Worker $$] Starting FAIR eval EMA=0.9 on $(hostname) at $(date)"
