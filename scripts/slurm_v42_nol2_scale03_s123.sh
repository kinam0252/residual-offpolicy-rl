#!/bin/bash
#SBATCH --job-name=mj_v42_nol2_scale03_s123
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v42_nol2_scale03_s123_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v42_nol2_scale03_s123_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v42_nol2_scale03_s123/${TIMESTAMP}"

echo "=== v42_nol2_scale03_s123: No L2 + scale=0.3 + seed=123, 500K steps ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v42_nol2_scale03_s123_${TIMESTAMP}" \
