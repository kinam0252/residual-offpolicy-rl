...
#SBATCH --mem=200G
#SBATCH --job-name=rl2_66ep_h_v2_s42
#SBATCH --output=/home/nas_main/kinamkim/slurms/rl2_66ep_h_v2_s42_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/rl2_66ep_h_v2_s42_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --output_dir outputs/mujoco_td3/gr00t_sim_66ep/hard_v2_s42 \
    --wandb_mode online \
    --wandb_project mujoco-resfit \
    --wandb_name rl2_66ep_hard_v2_s42
