#!/bin/bash
#SBATCH --job-name=mj_v43_nol2_long_ep
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v43_nol2_long_ep_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v43_nol2_long_ep_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v43_nol2_long_ep/${TIMESTAMP}"

echo "=== v43_nol2_long_ep: No L2 + scale=0.2 + 500 steps ep, 500K steps ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v43_nol2_long_ep_${TIMESTAMP}" \
