#!/bin/bash
#SBATCH --job-name=stk_sp5
#SBATCH --partition=sub
#SBATCH --qos=core-on-sub
#SBATCH --nodelist=worker-13
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=14
#SBATCH --mem=200G
#SBATCH --time=72:00:00
#SBATCH --output=/home/nas_main/kinamkim/slurms/stk_sp5_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/stk_sp5_%j.err
...
# Exp5: sparse + L2=0.1 (less regularization)
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco_stack.py \
    ...
    --action_scale 0.1 \
    --seed 42 \
    --output_dir outputs/stack_rl/sp5_g99_n3_l2lo
