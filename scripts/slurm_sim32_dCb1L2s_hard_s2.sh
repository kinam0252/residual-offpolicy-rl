...
#SBATCH --mem=200G
#SBATCH --job-name=mj_d1L2sh_s2
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_d1L2sh_s2_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_d1L2sh_s2_%j.err
