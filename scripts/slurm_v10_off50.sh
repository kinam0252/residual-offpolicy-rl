...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v10_off50_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v10_off50_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v10_off50/${TIMESTAMP}"

echo "=== v10_off50: 50% offline mixing ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v10_off50_${TIMESTAMP}" \
