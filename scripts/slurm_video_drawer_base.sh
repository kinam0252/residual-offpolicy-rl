#!/bin/bash
#SBATCH --job-name=vid_drawer_base
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/vid_drawer_base_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/vid_drawer_base_%j.err
