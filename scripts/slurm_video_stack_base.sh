#!/bin/bash
#SBATCH --job-name=vid_stack_base
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/vid_stack_base_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/vid_stack_base_%j.err
