...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v15_big_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v15_big_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v15_big/${TIMESTAMP}"

echo "=== v15_big: Big networks + offline ==="
