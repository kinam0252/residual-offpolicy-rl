...
#SBATCH --mem=200G
#SBATCH --job-name=rl_66ep_e
#SBATCH --output=/home/nas_main/kinamkim/slurms/rl_66ep_e_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/rl_66ep_e_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --output_dir outputs/mujoco_td3/gr00t_sim_66ep/easy_s1L2_s2 \
    --wandb_mode online \
    --wandb_project mujoco-resfit \
    --wandb_name rl_66ep_easy_s1L2_s2
