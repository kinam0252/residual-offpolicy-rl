#!/bin/bash
#SBATCH --job-name=mj_v94_70k_data
#SBATCH --partition=core
#SBATCH --qos=core-own
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=24
#SBATCH --mem=200G
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v94_70k_data_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v94_70k_data_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --offline_data_dir outputs/offline_data/sim_groot_v2_70k_noema_data \
    --offline_fraction 0.2 \
    --wandb_name v94_70k_data \
    --output_dir outputs/mujoco_td3/v94_70k_data \
