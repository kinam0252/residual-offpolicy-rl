...
#SBATCH --mem=200G
#SBATCH #SBATCH --job-name=mj_v89_explore
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v89_explore_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v89_explore_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name v89_off02_explore \
    --output_dir outputs/mujoco_td3/v89_off02_explore \
    --stddev_max 0.15 --stddev_min 0.03
