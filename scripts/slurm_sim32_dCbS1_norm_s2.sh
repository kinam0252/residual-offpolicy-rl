...
#SBATCH --mem=200G
#SBATCH --job-name=mj_dCS1nm_s2
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_dCS1nm_s2_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_dCS1nm_s2_%j.err
