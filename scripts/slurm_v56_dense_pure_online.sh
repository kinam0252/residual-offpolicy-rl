#!/bin/bash
#SBATCH --job-name=mj_v56_dense_pure_online
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v56_dense_pure_online_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v56_dense_pure_online_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name v56_dense_pure_online \
    --output_dir outputs/mujoco_td3/v56_dense_pure_online \
    --offline_data_dir outputs/offline_data/dense_v1_20260404_224233 \
    --action_l2_reg 0.1 --action_scale 0.2 --max_episode_steps 500 --exploration_noise 0.1 --offline_fraction 0
