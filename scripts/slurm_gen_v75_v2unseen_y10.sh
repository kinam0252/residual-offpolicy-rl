...
#SBATCH --mem=200G
#SBATCH --time=2:00:00
#SBATCH --job-name=gen_v75_v2unseen_y10
#SBATCH --output=/home/nas_main/kinamkim/slurms/gen_v75_v2unseen_y10_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/gen_v75_v2unseen_y10_%j.err
...
python -m resfit.rl_finetuning.scripts.eval_checkpoint \
    ...
    --seed 42 \
    --cube_yaw 10.0 \
    --output_json outputs/eval_results/gen_v75_v2unseen_y10.json \
    --label gen_v75_v2unseen_y10
