...
#SBATCH --mem=80G
#SBATCH --job-name=vid_ema09
#SBATCH --output=/home/nas_main/kinamkim/slurms/vid_ema09_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/vid_ema09_%j.err
#SBATCH --time=2:00:00
