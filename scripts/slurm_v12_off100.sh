...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v12_off100_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v12_off100_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v12_off100/${TIMESTAMP}"

echo "=== v12_off100: 100% offline (pure offline) ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v12_off100_${TIMESTAMP}" \
