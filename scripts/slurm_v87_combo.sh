...
#SBATCH --mem=200G
#SBATCH #SBATCH --job-name=mj_v87_combo
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v87_combo_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v87_combo_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name v87_off02_tau005 \
    --output_dir outputs/mujoco_td3/v87_off02_tau005 \
