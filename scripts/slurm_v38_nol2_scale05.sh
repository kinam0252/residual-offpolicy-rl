#!/bin/bash
#SBATCH --job-name=mj_v38_nol2_scale05
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v38_nol2_scale05_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v38_nol2_scale05_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v38_nol2_scale05/${TIMESTAMP}"

echo "=== v38_nol2_scale05: No L2 + scale=0.5, 500K steps ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v38_nol2_scale05_${TIMESTAMP}" \
