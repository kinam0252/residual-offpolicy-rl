...
#SBATCH --mem=64G
#SBATCH --time=4:00:00
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_offd3_e6_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_offd3_e6_%j.err
...
echo "=== Offline Data Collection env6 ==="
