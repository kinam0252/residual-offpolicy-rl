#!/bin/bash
#SBATCH --job-name=mj_v54_dense_nol2_scale02
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v54_dense_nol2_scale02_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v54_dense_nol2_scale02_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name v54_dense_nol2_scale02 \
    --output_dir outputs/mujoco_td3/v54_dense_nol2_scale02 \
    --offline_data_dir outputs/offline_data/dense_v1_20260404_224233 \
    --action_l2_reg 0 --action_scale 0.2 --max_episode_steps 500 --exploration_noise 0.1 --offline_fraction 0.5
