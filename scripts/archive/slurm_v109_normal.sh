...
#SBATCH --mem=200G
#SBATCH --job-name=mj_v109_normal
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v109_normal_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v109_normal_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --num_envs 10 \
    --random_cube_range '{"dx":[-8,14],"dy":[-15,15],"yaw":[-40,40]}' \
    --reward_type dense \
    ...
    --offline_data_dir outputs/offline_data/sim_groot_v2_100k_merged \
    --offline_fraction 0.2 \
    --wandb_name v109_100k_normal \
    --output_dir outputs/mujoco_td3/v109_100k_normal \
    --stddev_max 0.05 --stddev_min 0.05 \
    --target_tau 0.005 \
    --eval_perturb_table configs/eval_table_normal.json
