#!/bin/bash
#SBATCH --job-name=col70k_hard
#SBATCH --partition=core
#SBATCH --qos=core-own
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=14
#SBATCH --mem=200G
#SBATCH --output=/home/nas_main/kinamkim/slurms/col70k_hard_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/col70k_hard_%j.err
...
python3 resfit/rl_finetuning/scripts/collect_offline_data.py \
    ...
    --output_dir outputs/offline_data/sim_groot_v2_70k_noema_hard \
