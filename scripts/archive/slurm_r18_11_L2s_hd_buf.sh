...
#SBATCH --mem=200G
#SBATCH --job-name=mj_r18Bbufh
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_r18Bbufh_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_r18Bbufh_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --output_dir outputs/mujoco_td3/gr00t_sim_32ep/r18_s1_L2s01_hard_buf100k \
    --wandb_mode online \
    --wandb_project mujoco-resfit \
    --wandb_name sim32_r18_s1_L2s01_hard_buf100k
