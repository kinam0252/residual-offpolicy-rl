#!/bin/bash
#SBATCH --job-name=mj_v84_matched
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v84_matched_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v84_matched_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name v84_matched_offline \
    --output_dir outputs/mujoco_td3/v84_matched_offline \
    --offline_data_dir outputs/offline_data/dense_rand_normal \
