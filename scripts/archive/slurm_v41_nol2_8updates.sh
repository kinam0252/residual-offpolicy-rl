#!/bin/bash
#SBATCH --job-name=mj_v41_nol2_8updates
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v41_nol2_8updates_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v41_nol2_8updates_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v41_nol2_8updates/${TIMESTAMP}"

echo "=== v41_nol2_8updates: No L2 + scale=0.2 + 8 updates, 500K steps ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v41_nol2_8updates_${TIMESTAMP}" \
