...
#SBATCH --output=/home/nas_main/kinamkim/slurms/stk_dn10_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/stk_dn10_%j.err
...
# dn10: as=0.05, L2=0.1 (small as + medium L2)
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco_stack.py \
    ...
    --action_scale 0.05 \
    --seed 42 \
    --output_dir outputs/stack_rl/dn10_a05_l2_01
