#!/bin/bash
#SBATCH --job-name=mj_v72_pt_yaw5
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v72_pt_yaw5_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v72_pt_yaw5_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name v72_pt_yaw5 \
    --output_dir outputs/mujoco_td3/v72_pt_yaw5 \
