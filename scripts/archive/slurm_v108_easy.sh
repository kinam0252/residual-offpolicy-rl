...
#SBATCH --mem=200G
#SBATCH --job-name=mj_v108_easy
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v108_easy_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v108_easy_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --num_envs 10 \
    --random_cube_range '{"dx":[-8,14],"dy":[-15,15],"yaw":[-15,15]}' \
    --reward_type dense \
    ...
    --wandb_name v108_100k_easy \
    --output_dir outputs/mujoco_td3/v108_100k_easy \
    --stddev_max 0.05 --stddev_min 0.05 \
    --target_tau 0.005 \
    --eval_perturb_table configs/eval_table_easy.json
