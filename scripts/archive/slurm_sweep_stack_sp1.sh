...
#SBATCH --output=/home/nas_main/kinamkim/slurms/stk_sp1_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/stk_sp1_%j.err
...
# Exp1: sparse baseline (g=0.99, n=3, as=0.1, L2=1.0)
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco_stack.py \
    ...
    --action_scale 0.1 \
    --seed 42 \
    --output_dir outputs/stack_rl/sp1_g99_n3_a10
