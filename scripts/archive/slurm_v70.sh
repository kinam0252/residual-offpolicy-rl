#!/bin/bash
#SBATCH --job-name=mj_v70_pt_yaw0
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v70_pt_yaw0_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v70_pt_yaw0_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name v70_pt_yaw0 \
    --output_dir outputs/mujoco_td3/v70_pt_yaw0 \
