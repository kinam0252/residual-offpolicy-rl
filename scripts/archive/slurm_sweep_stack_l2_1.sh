...
#SBATCH --output=/home/nas_main/kinamkim/slurms/stk_l2_1_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/stk_l2_1_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco_stack.py \
    ...
    --action_scale 0.2 \
    --seed 42 \
    --output_dir outputs/stack_rl/sweep_l2_1_a02_l001_r05
