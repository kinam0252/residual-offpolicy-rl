#!/bin/bash
#SBATCH --job-name=mj_v106_imp_hard
#SBATCH --partition=core
#SBATCH --qos=core-extra
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=14
#SBATCH --mem=200G
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v106_imp_hard_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v106_imp_hard_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --offline_data_dir outputs/offline_data/sim_groot_v2_70k_noema_hard_success \
    --offline_fraction 0.1 \
    --wandb_name v106_imp_hard \
    --output_dir outputs/mujoco_td3/v106_imp_hard \
