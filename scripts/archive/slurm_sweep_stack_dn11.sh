...
#SBATCH --output=/home/nas_main/kinamkim/slurms/stk_dn11_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/stk_dn11_%j.err
...
# dn11: as=0.1, L2=1.0, n_step=5 (r05a1 + longer n_step)
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco_stack.py \
    ...
    --wandb_mode offline \
    --reward_type dense --offline_reward_relabel none \
    --residual_rot_scale 0.05 \
    --action_scale 0.1 \
    --seed 42 \
    --output_dir outputs/stack_rl/dn11_a10_n5
