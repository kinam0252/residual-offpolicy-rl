#!/bin/bash
#SBATCH --job-name=mj_v45_nol2_scale02_ep500
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v45_nol2_scale02_ep500_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v45_nol2_scale02_ep500_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v45_nol2_scale02_ep500/${TIMESTAMP}"

echo "=== v45_nol2_scale02_ep500: No L2 + scale=0.2 + ep500, 500K steps ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v45_nol2_scale02_ep500_${TIMESTAMP}" \
