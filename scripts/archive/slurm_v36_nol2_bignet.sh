#!/bin/bash
#SBATCH --job-name=mj_v36_nol2_bignet
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v36_nol2_bignet_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v36_nol2_bignet_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v36_nol2_bignet/${TIMESTAMP}"

echo "=== v36_nol2_bignet: No L2 + big net 1024/2048, 500K steps ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v36_nol2_bignet_${TIMESTAMP}" \
