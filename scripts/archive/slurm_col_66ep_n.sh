#!/bin/bash
#SBATCH --job-name=col_66ep_n
#SBATCH --output=/home/nas_main/kinamkim/slurms/col_66ep_n_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/col_66ep_n_%j.out
...
python3 resfit/rl_finetuning/scripts/collect_offline_data.py \
    ...
    --output_dir /home/nas_main/kinamkim/Repos/Intern/outputs/offline_data/gr00t_sim_66ep/normal \
