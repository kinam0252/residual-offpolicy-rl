...
#SBATCH --mem=200G
#SBATCH --job-name=eval_100ep_hard
#SBATCH --output=/home/nas_main/kinamkim/slurms/eval_100ep_hard_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/eval_100ep_hard_%j.err
...
python3 resfit/rl_finetuning/scripts/eval_checkpoint.py \
    ...
    --save_video \
    --video_dir /home/nas_main/kinamkim/Repos/Intern/residual-offpolicy-rl/outputs/eval_videos/100ep/hard \
    --label 100ep_hard_best \
    --seed 42
