#!/bin/bash
#SBATCH --job-name=col32_hard_p3
#SBATCH --partition=core
#SBATCH --qos=core-extra
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=14
#SBATCH --mem=200G
#SBATCH --output=/home/nas_main/kinamkim/slurms/col32_hard_p3_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/col32_hard_p3_%j.err
...
python3 resfit/rl_finetuning/scripts/collect_offline_data.py \
    ...
    --perturb_table configs/collect_table_hard.json \
    --num_episodes_per_env 10 \
    --max_episode_steps 500 \
    --output_dir outputs/offline_data/gr00t_sim_32ep/hard_part3 \
    --env_ids 24 25 26 27 28 29 30 31 
