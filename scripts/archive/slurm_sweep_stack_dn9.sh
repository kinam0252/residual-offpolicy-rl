...
#SBATCH --output=/home/nas_main/kinamkim/slurms/stk_dn9_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/stk_dn9_%j.err
...
# dn9: as=0.1, L2=0.1 (r05a1 + medium L2)
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco_stack.py \
    ...
    --action_scale 0.1 \
    --seed 42 \
    --output_dir outputs/stack_rl/dn9_a10_l2_01
