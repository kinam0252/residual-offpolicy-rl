...
#SBATCH --mem=200G
#SBATCH --job-name=mj_v111_easy
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v111_easy_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v111_easy_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --action_l2_reg 0.1 \
    --offline_data_dir outputs/offline_data/sim_groot_v2_100k_easy_merged \
    ...
    --output_dir outputs/mujoco_td3/v111_100k_easy \
    --wandb_mode online \
    --wandb_project mujoco-resfit \
    --wandb_name v111_100k_easy
