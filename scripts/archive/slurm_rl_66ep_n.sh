...
#SBATCH --mem=200G
#SBATCH --job-name=rl_66ep_n
#SBATCH --output=/home/nas_main/kinamkim/slurms/rl_66ep_n_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/rl_66ep_n_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --action_l2_reg 0.01 \
    --offline_data_dir /home/nas_main/kinamkim/Repos/Intern/outputs/offline_data/gr00t_sim_66ep/normal \
    ...
    --output_dir outputs/mujoco_td3/gr00t_sim_66ep/normal_s1L2_s2 \
    --wandb_mode online \
    --wandb_project mujoco-resfit \
    --wandb_name rl_66ep_normal_s1L2_s2
