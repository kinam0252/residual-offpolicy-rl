...
#SBATCH --output=/home/nas_main/kinamkim/slurms/stk_dn8_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/stk_dn8_%j.err
...
# dn8: as=0.1, L2=0.01 (r05a1 + lower L2)
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco_stack.py \
    ...
    --action_scale 0.1 \
    --seed 42 \
    --output_dir outputs/stack_rl/dn8_a10_l2_001
