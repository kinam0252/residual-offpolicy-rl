#!/bin/bash
#SBATCH --job-name=mj_v80_rand_easy
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v80_rand_easy_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v80_rand_easy_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name v80_rand_easy \
    --output_dir outputs/mujoco_td3/v80_rand_easy \
