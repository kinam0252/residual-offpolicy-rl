#!/bin/bash
#SBATCH --job-name=mj_v82_rand_hard
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v82_rand_hard_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v82_rand_hard_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name v82_rand_hard \
    --output_dir outputs/mujoco_td3/v82_rand_hard \
