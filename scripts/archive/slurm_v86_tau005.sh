...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v86_tau005_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v86_tau005_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name v86_tau005 \
    --output_dir outputs/mujoco_td3/v86_tau005 \
