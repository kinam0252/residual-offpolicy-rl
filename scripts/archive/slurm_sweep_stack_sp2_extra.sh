...
#SBATCH --output=/home/nas_main/kinamkim/slurms/stk_sp2_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/stk_sp2_%j.err
...
# Exp2: sparse + n_step=5 (longer signal propagation)
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco_stack.py \
    ...
    --action_scale 0.1 \
    --seed 42 \
    --output_dir outputs/stack_rl/sp2_g99_n5_a10
