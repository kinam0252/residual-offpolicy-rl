#!/bin/bash
#SBATCH --job-name=beval_100ep_h
#SBATCH --partition=core
#SBATCH --qos=core-own
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=14
#SBATCH --mem=200G
#SBATCH --output=/home/nas_main/kinamkim/slurms/beval_100ep_h_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/beval_100ep_h_%j.err
#SBATCH --time=4:00:00
...
export EVAL_OUT=outputs/100ep/base_eval_hard
