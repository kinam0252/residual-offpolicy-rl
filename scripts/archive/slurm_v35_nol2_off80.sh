#!/bin/bash
#SBATCH --job-name=mj_v35_nol2_off80
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v35_nol2_off80_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v35_nol2_off80_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v35_nol2_off80/${TIMESTAMP}"

echo "=== v35_nol2_off80: No L2 + 80%% offline, 500K steps ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v35_nol2_off80_${TIMESTAMP}" \
