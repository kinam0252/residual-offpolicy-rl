...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v13_off30_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v13_off30_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v13_off30/${TIMESTAMP}"

echo "=== v13_off30: 30% offline mixing ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v13_off30_${TIMESTAMP}" \
