#!/bin/bash
#SBATCH --job-name=mj_v81_rand_normal
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v81_rand_normal_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v81_rand_normal_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name v81_rand_normal \
    --output_dir outputs/mujoco_td3/v81_rand_normal \
