...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v18_dense_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v18_dense_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v18_dense/${TIMESTAMP}"

echo "=== v18_dense: Dense reward (unclipped) ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v18_dense_${TIMESTAMP}" \
