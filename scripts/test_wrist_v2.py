...
import mujoco
from mujoco import gl_context  # older API
...
# Use offscreen rendering with raw MuJoCo C API
W, H = 640, 360
...
import imageio
imageio.imwrite('/home/nas_main/kinamkim/Repos/Intern/residual-offpolicy-rl/scripts/pnp_wrist_defaults.png', frame)
print('Saved pnp_wrist_defaults.png')
