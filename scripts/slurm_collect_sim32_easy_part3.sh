#!/bin/bash
#SBATCH --job-name=col32_easy_p3
#SBATCH --partition=core
#SBATCH --qos=core-extra
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=24
#SBATCH --mem=200G
#SBATCH --output=/home/nas_main/kinamkim/slurms/col32_easy_p3_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/col32_easy_p3_%j.err
...
python3 resfit/rl_finetuning/scripts/collect_offline_data.py \
    ...
    --output_dir outputs/offline_data/gr00t_sim_32ep/easy_part3 \
