#!/bin/bash
#SBATCH --job-name=mj_v37_nol2_fastactor
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v37_nol2_fastactor_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v37_nol2_fastactor_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v37_nol2_fastactor/${TIMESTAMP}"

echo "=== v37_nol2_fastactor: No L2 + scale=0.2 + actor_lr=3e-5, 500K steps ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v37_nol2_fastactor_${TIMESTAMP}" \
