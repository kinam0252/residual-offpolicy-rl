#!/bin/bash
#SBATCH --job-name=mj_v21_bigscale
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v21_bigscale_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v21_bigscale_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v21_bigscale/${TIMESTAMP}"

echo "=== v21_bigscale: Bigger action scale ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v21_bigscale_${TIMESTAMP}" \
