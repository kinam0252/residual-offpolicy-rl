#!/bin/bash
#SBATCH --job-name=mj_v22_lowscale
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v22_lowscale_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v22_lowscale_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v22_lowscale/${TIMESTAMP}"

echo "=== v22_lowscale: Lower action scale ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v22_lowscale_${TIMESTAMP}" \
