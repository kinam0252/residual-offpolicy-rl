...
#SBATCH --mem=200G
#SBATCH --job-name=mj_slA_easy
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_slA_easy_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_slA_easy_%j.err
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --action_l2_reg 0.0 \
    --offline_data_dir outputs/offline_data/gr00t_sim_32ep/slowActor_easy_merged \
    ...
    --output_dir outputs/mujoco_td3/gr00t_sim_32ep/slowActor_easy \
    --wandb_mode online \
    --wandb_project mujoco-resfit \
    --wandb_name sim32_slowActor_easy
