#!/bin/bash
#SBATCH --job-name=mj_v40_nol2_fastcritic
...
#SBATCH --output=/home/nas_main/kinamkim/slurms/mj_v40_nol2_fastcritic_%j.out
#SBATCH --error=/home/nas_main/kinamkim/slurms/mj_v40_nol2_fastcritic_%j.err
...
OUTPUT_DIR="outputs/mujoco_td3_v40_nol2_fastcritic/${TIMESTAMP}"

echo "=== v40_nol2_fastcritic: No L2 + scale=0.2 + critic_lr=3e-4, 500K steps ==="
...
python3 resfit/rl_finetuning/scripts/train_residual_td3_mujoco.py \
    ...
    --wandb_name "v40_nol2_fastcritic_${TIMESTAMP}" \
